import {CustomFieldConfig, CustomFields, CustomFieldType} from '@picker-cc/common/lib/shared-types';
import { assertNever, getGraphQlInputName } from '@picker-cc/common/lib/shared-utils';
import {
    buildSchema,
    extendSchema,
