import { AssetListOptions, AssetType, CreateAssetInput } from '@picker-cc/common/lib/generated-types';
...
export class AssetService {
    ...
    async createFromBuffer(ctx: RequestContext, data): Promise<Asset> {
