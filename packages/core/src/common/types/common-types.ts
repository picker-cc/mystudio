 ...
 * 列表查询的参数
 */
export interface ListQueryOptions<T extends PickerMongoEntity> {
  take?: number | null;
  skip?: number | null;
...
// prettier-ignore
export type PrimitiveFields<T extends PickerMongoEntity> = {
  [K in keyof T]: T[K] extends number | string | boolean | Date ? K : never
}[keyof T];
//
// prettier-ignore
export type SortParameter<T extends PickerMongoEntity> = {
...
// prettier-ignore
export type FilterParameter<T extends PickerMongoEntity> = {
